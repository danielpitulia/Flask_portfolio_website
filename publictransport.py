...
def get_timetables(user_input_stopID):
    format = "json"
    ...
    for x in departures:
        ...
        direction += [x['direction']] # Extra brackets are for converting strings into one list item and not one list item per character

        # print(vehicle + " arrival: " + delta + " min. Departure = " + dep_date.strftime("%H:%M") + " Direction = " + x['direction'])
